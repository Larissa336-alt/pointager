...
export const TimeClockCard: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const entries = await supabaseService.getTimeEntries(user.employee.id, startOfDay, endOfDay);
  ...
  const handleFaceCapture = async (faceEncoding: string) => {
    ...
    // Here you would compare the captured face with the stored encoding
